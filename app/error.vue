<template>
  <main class="flex flex-col min-h-screen w-full scroll-smooth">
    <div class="flex items-center justify-center h-screen">
      ...
      >
        <div class="max-w-md">
          ...
          <button
            class="px-14 py-4 bg-[#186b6d] text-white font-medium text-sm leading-snug uppercase rounded-md shadow-md hover: hover:bg-[#125152] hover:shadow-lg focus:bg-[#125152] focus:shadow-lg focus:outline-none focus:ring-0 active:bg-[#125152] active:shadow-lg transition duration-150 ease-in-out mr-4"
            to="/"
            role="button"
            @click="handleError"
          >
